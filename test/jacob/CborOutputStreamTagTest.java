...
public class CborOutputStreamTagTest extends CborOutputStreamTestBase<Integer> {
    private final Object m_data;

    /**
     * Creates a new {@link CborOutputStreamTagTest} instance.
     */
    public CborOutputStreamTagTest(int type, Object data, int[] encodedOutput) {
    ...
    public void testEncodeInput() throws IOException {
        m_stream.writeTag(m_input.intValue(), m_data);
