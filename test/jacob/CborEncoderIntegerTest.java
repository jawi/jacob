...
public class CborEncoderIntegerTest extends CborEncoderTestBase<Long> {

    /**
     * Creates a new {@link CborEncoderIntegerTest} instance.
     */
    public CborEncoderIntegerTest(long input, int[] encodedOutput) {
