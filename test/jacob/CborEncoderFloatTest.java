...
public class CborEncoderFloatTest extends CborEncoderTestBase<Float> {

    /**
     * Creates a new {@link CborEncoderFloatTest} instance.
     */
    public CborEncoderFloatTest(float input, int[] encodedOutput) {
