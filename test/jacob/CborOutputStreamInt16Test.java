...
public class CborOutputStreamInt16Test extends CborOutputStreamTestBase<Integer> {

    /**
     * Creates a new {@link CborOutputStreamInt16Test} instance.
     */
    public CborOutputStreamInt16Test(int input, int[] encodedOutput) {
