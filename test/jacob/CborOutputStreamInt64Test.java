...
public class CborOutputStreamInt64Test extends CborOutputStreamTestBase<Long> {

    /**
     * Creates a new {@link CborOutputStreamInt64Test} instance.
     */
    public CborOutputStreamInt64Test(long input, int[] encodedOutput) {
