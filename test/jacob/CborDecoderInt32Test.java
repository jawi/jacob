...
public class CborDecoderInt32Test extends CborDecoderTestBase<Long> {
    public CborDecoderInt32Test(long output, int[] encodedInput, Class<? extends Exception> exceptionType) {
