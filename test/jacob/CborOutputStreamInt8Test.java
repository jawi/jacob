...
public class CborOutputStreamInt8Test extends CborOutputStreamTestBase<Integer> {

    /**
     * Creates a new {@link CborOutputStreamInt8Test} instance.
     */
    public CborOutputStreamInt8Test(int input, int[] encodedOutput) {
